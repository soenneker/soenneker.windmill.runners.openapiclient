...
public sealed class FileOperationsUtil : IFileOperationsUtil
{
    ...
    public FileOperationsUtil(ILogger<FileOperationsUtil> logger, IConfiguration configuration, IGitUtil gitUtil, IDotnetUtil dotnetUtil,
        ...
        IYamlUtil yamlUtil, IOpenApiFixer openApiFixer)
    {
        _logger = logger;
    ...
    public async ValueTask Process(CancellationToken cancellationToken = default)
    {
        ...
        string openApiDocumentUrl = _configuration["Windmill:ClientGenerationUrl"] ?? "https://app.windmill.dev/api/openapi.yaml";
        ...
        await _kiotaUtil.Generate(fixedFilePath, "WindmillOpenApiClient", Constants.Library, gitDirectory, cancellationToken).NoSync();
